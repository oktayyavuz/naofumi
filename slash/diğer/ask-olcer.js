...
module.exports = {
    name: "aşkölçer",
    description: "İki kullanıcı arasında aşk seviyesini ölçer ve gösterir.",
    options: [
        {
            name: "kullanıcı1",
            description: "Birinci kullanıcıyı seçin",
            type: 6,  // USER type
            required: true
        },
        {
            name: "kullanıcı2",
            description: "İkinci kullanıcıyı seçin",
            type: 6,  // USER type
            required: true
        }
    ],
    run: async (client, interaction) => {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setColor(0xff69b4) // Pembe bir renk
